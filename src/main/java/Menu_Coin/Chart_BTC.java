...
public class Chart_BTC {
    public static void main(String[] args) throws Exception {
        ...
        XYChart chart = QuickChart.getChart("Bitcoin Chart", "Timestamp", "Won", "BTC_Chart", null, data[1]); // x y데이터를 더블형으로 받음
        ...
        while (true) {
            ...
            chart.updateXYSeries("BTC_Chart", null, APIData[1], null); // null은 x Apidata는 y
            sw.repaintChart();
        }
    }
    ...
    private static double updateData() {
        ...
        try {
            ...
            Request request = new Request.Builder()
                    .url("https://api.upbit.com/v1/candles/minutes/1?market=" + coin[0] + "&count=1")
                    .get()
